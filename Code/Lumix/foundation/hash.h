...
struct LUMIX_FOUNDATION_API RuntimeHash {
...
struct LUMIX_FOUNDATION_API RuntimeHash32 {
...
// 64bits 
struct LUMIX_FOUNDATION_API StableHash {
...
struct LUMIX_FOUNDATION_API StableHash32 {
...
struct LUMIX_FOUNDATION_API RollingStableHasher {
	void begin();
...
struct LUMIX_FOUNDATION_API RollingHasher {
	void begin();
	void update(const void* data, u32 len);
	RuntimeHash32 end();
};
