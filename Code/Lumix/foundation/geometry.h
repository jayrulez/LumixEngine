...
struct LUMIX_FOUNDATION_API Ray {
	DVec3 origin;
	Vec3 dir;
};

struct LUMIX_FOUNDATION_API Sphere {
	Sphere();
...
struct alignas(16) LUMIX_FOUNDATION_API Frustum {
	Frustum();
...
struct alignas(16) LUMIX_FOUNDATION_API ShiftedFrustum {
...
struct LUMIX_FOUNDATION_API AABB {
	AABB();
...
struct LUMIX_FOUNDATION_API Viewport {
...
LUMIX_FOUNDATION_API Vec4 makePlane(const Vec3& normal, const Vec3& point);
LUMIX_FOUNDATION_API float planeDist(const Vec4& plane, const Vec3& point);

LUMIX_FOUNDATION_API bool getRayPlaneIntersecion(const Vec3& origin, const Vec3& dir, const Vec3& plane_point, const Vec3& normal, float& out);
LUMIX_FOUNDATION_API bool getRaySphereIntersection(const Vec3& origin, const Vec3& dir, const Vec3& center, float radius, float& out);
LUMIX_FOUNDATION_API bool getRayAABBIntersection(const Vec3& origin, const Vec3& dir, const Vec3& min, const Vec3& size, Vec3& out);
LUMIX_FOUNDATION_API float getLineSegmentDistance(const Vec3& origin, const Vec3& dir, const Vec3& a, const Vec3& b);
LUMIX_FOUNDATION_API bool getRayTriangleIntersection(const Vec3& origin, const Vec3& dir, const Vec3& a, const Vec3& b, const Vec3& c, float* out_t);
LUMIX_FOUNDATION_API bool getSphereTriangleIntersection(const Vec3& center, float radius, const Vec3& v0, const Vec3& v1, const Vec3& v2);
LUMIX_FOUNDATION_API bool testOBBCollision(const AABB& a, const Matrix& mtx_b, const AABB& b);
LUMIX_FOUNDATION_API bool testAABBTriangleCollision(const AABB& aabb, const Vec3& a, const Vec3& b, const Vec3& c);
