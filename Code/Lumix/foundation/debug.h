...
LUMIX_FOUNDATION_API void debugBreak();
LUMIX_FOUNDATION_API void debugOutput(const char* message);
LUMIX_FOUNDATION_API void enableFloatingPointTraps(bool enable);


struct StackNode;


struct LUMIX_FOUNDATION_API StackTree
{
public:
	StackTree();
	~StackTree();
...
#ifdef _WIN32
struct LUMIX_FOUNDATION_API GuardAllocator final : IAllocator {
...
struct LUMIX_FOUNDATION_API Allocator final : IAllocator {
...
LUMIX_FOUNDATION_API void enableCrashReporting(bool enable);
LUMIX_FOUNDATION_API void installUnhandledExceptionHandler();
LUMIX_FOUNDATION_API void clearHardwareBreakpoint(u32 breakpoint_idx);
LUMIX_FOUNDATION_API void setHardwareBreakpoint(u32 breakpoint_idx, const void* mem, u32 size);
