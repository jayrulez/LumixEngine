...
LUMIX_FOUNDATION_API int stringLength(const char* str);
...
LUMIX_FOUNDATION_API const char* findInsensitive(StringView haystack, StringView needle);
LUMIX_FOUNDATION_API void toCStringHex(u8 value, Span<char> output);
LUMIX_FOUNDATION_API void toCStringPretty(i32 value, Span<char> output);
LUMIX_FOUNDATION_API void toCStringPretty(u32 value, Span<char> output);
LUMIX_FOUNDATION_API void toCStringPretty(u64 value, Span<char> output);
LUMIX_FOUNDATION_API char* toCString(bool value, Span<char> output);
LUMIX_FOUNDATION_API char* toCString(i32 value, Span<char> output);
LUMIX_FOUNDATION_API char* toCString(i64 value, Span<char> output);
LUMIX_FOUNDATION_API char* toCString(u64 value, Span<char> output);
LUMIX_FOUNDATION_API char* toCString(u32 value, Span<char> output);
LUMIX_FOUNDATION_API char* toCString(float value, Span<char> output, int after_point);
LUMIX_FOUNDATION_API char* toCString(double value, Span<char> output, int after_point);
LUMIX_FOUNDATION_API const char* fromCStringOctal(StringView input, u32& value);
LUMIX_FOUNDATION_API const char* fromCString(StringView input, i32& value);
LUMIX_FOUNDATION_API const char* fromCString(StringView input, u64& value);
LUMIX_FOUNDATION_API const char* fromCString(StringView input, i64& value);
LUMIX_FOUNDATION_API const char* fromCString(StringView input, u32& value);
LUMIX_FOUNDATION_API const char* fromCString(StringView input, u16& value);
LUMIX_FOUNDATION_API const char* fromCString(StringView input, bool& value);
LUMIX_FOUNDATION_API char* copyString(Span<char> output, StringView source);
LUMIX_FOUNDATION_API char* catString(Span<char> output, StringView source);
LUMIX_FOUNDATION_API bool makeLowercase(Span<char> output, StringView source);
LUMIX_FOUNDATION_API bool equalStrings(const char* lhs, const char* rhs);
LUMIX_FOUNDATION_API bool equalStrings(StringView lhs, StringView rhs);
LUMIX_FOUNDATION_API bool equalIStrings(StringView lhs, StringView rhs);
LUMIX_FOUNDATION_API int compareString(StringView lhs, StringView rhs);
LUMIX_FOUNDATION_API const char* reverseFind(StringView haystack, char c);
LUMIX_FOUNDATION_API const char* find(StringView str, char needle);
LUMIX_FOUNDATION_API bool contains(StringView haystack, char needle);
LUMIX_FOUNDATION_API bool startsWith(StringView str, StringView prefix);
LUMIX_FOUNDATION_API bool startsWithInsensitive(StringView str, StringView prefix);
LUMIX_FOUNDATION_API bool endsWith(StringView str, StringView suffix);
LUMIX_FOUNDATION_API bool endsWithInsensitive(StringView str, StringView suffix);
LUMIX_FOUNDATION_API bool isLetter(char c);
LUMIX_FOUNDATION_API bool isNumeric(char c);
LUMIX_FOUNDATION_API bool isUpperCase(char c);
...
struct LUMIX_FOUNDATION_API String {
