...
struct TerrainEditor final : StudioApp::MousePlugin {
	...
	void updateSplatmap(struct Terrain* terrain, OutputMemoryStream&& new_data, u32 x, u32 y, u32 w, u32 h, bool dirty_grass);
	void updateHeightmap(Terrain* terrain, OutputMemoryStream&& new_data, u32 x, u32 y, u32 w, u32 h);
